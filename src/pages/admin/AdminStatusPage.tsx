  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#111111] pb-24 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-10">
        ...
        {/* ── SECTION 1: HOMEPAGE HERO BANNERS MANAGEMENT ── */}
        <div className="bg-white rounded-[26px] border border-gray-200 p-6 sm:p-8 shadow-xs space-y-6">
          ...
          <form onSubmit={handleAddBannerSubmit} className="space-y-4 text-xs font-sans bg-gray-50 p-5 rounded-2xl border border-gray-200">
            ...
            <button
              ...
              className="bg-[#F97316] hover:bg-[#EA580C] text-white font-heading font-black text-xs px-5 py-3 rounded-xl shadow-md flex items-center gap-2 transition-all active:scale-95"
            >
              ...
              {banners.map((b) => (
                <div key={b.id} className="p-4 rounded-2xl border border-gray-200 bg-gray-50 flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="p-2.5 text-red-600 hover:bg-red-100 rounded-xl shrink-0 transition-colors"
                    title="Delete Banner"
                  >
                    <Trash2 size={18} />
                  </button>
        ...
        {/* ── SECTION 2: 24H WORKSHOP STATUS STORIES ── */}
        <div className="bg-white rounded-[26px] border border-gray-200 p-6 sm:p-8 shadow-xs space-y-6">
          <div className="flex items-center justify-between border-b border-gray-200 pb-4">
            <h3 className="font-heading font-black text-lg text-[#111111] flex items-center gap-2">
          ...
          <form onSubmit={handlePostStory} className="space-y-5 text-xs font-sans">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-center bg-gray-50 p-4 rounded-2xl border border-gray-200">
              <div className="relative h-40 rounded-xl overflow-hidden bg-black border-2 border-dashed border-gray-300 flex items-center justify-center group">
                {mediaUrl ? (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {presetImages.map((p) => (
                      <button
                        ...
                        className="bg-white hover:bg-gray-100 text-gray-700 text-[10px] font-mono px-2.5 py-1 rounded-lg border border-gray-300"
                      >
                        {p.name}
                      </button>
                    ))}
            ...
            <div className="flex items-center justify-between pt-3 border-t border-gray-200">
              <button
                ...
                className="bg-[#F97316] hover:bg-[#EA580C] text-white font-heading font-black text-xs px-6 py-3.5 rounded-xl shadow-lg flex items-center gap-2 transition-transform active:scale-95"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {stories.map((s) => (
              <div key={s.id} className="p-4 bg-white rounded-2xl flex items-center gap-4 border border-gray-200 shadow-xs">
                <img src={s.mediaUrl} alt={s.title} className="w-16 h-16 object-cover rounded-xl shrink-0 border border-gray-300" />
                ...
                <button
                  ...
                  className="p-2.5 text-red-600 hover:bg-red-50 rounded-xl shrink-0 transition-colors"
                  title="Delete story"
                >
                  <Trash2 size={18} />
                </button>
