        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-end sm:items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={exportToPDF}
                className="bg-white/20 hover:bg-white/30 text-white font-heading font-black text-xs px-4 py-2.5 rounded-xl border border-white/20 flex items-center gap-1.5 transition-all cursor-pointer"
              >
                <Printer size={14} /> Export PDF Report
              </button>
            </div>

            <div className="bg-white/10 p-3.5 rounded-xl border border-white/10 text-right font-mono shrink-0">
